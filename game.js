...
function updateMarten(dt) {
  ...
  if (martenState === 'escaping') {
    ...
    const escapeSpeed = 6.2; // wyraźny, szybki, ale w pełni widoczny sprint
    if (tdist < 0.6) {
      martenEscapeIndex++;
      ...
      const dirX = tdx / tdist, dirZ = tdz / tdist;
    ...
    return; // podczas sprintu: brak błądzenia, brak możliwości złapania
  }
  ...
  const nearMissRadius = 3.6; // próg, przy którym kuna zaczyna sprintem uciekać zamiast dać się złapać
